...
<div class="home-page">
    <div class="home-container">
        ...
        <form class="create-event-form" action="<%= request.getContextPath() %>/PostAnnouncementServlet"
            ...
            <!-- Upload Image -->
            <input type="file" name="imagePath" accept=".jpg,.png,image/jpeg,image/png" placeholder="Image (optional)">

            <!-- Upload File Attachment -->
            <input type="file" name="attachmentPath" accept=".pdf,application/pdf" placeholder="Attachment (optional)">
